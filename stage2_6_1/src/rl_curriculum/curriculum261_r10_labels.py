# -*- coding: utf-8 -*-
"""阶段 2.6.1 Repair R10:PolicyVisibleSupervisedLabel-v1(§8)。
...
def _build_env_for(episode: Any, schema: Any) -> Any:
    ...
    features = select_features_strict(
        episode.df, schema, context="supervised_label_r10")
...
def collect_policy_visible_dataset_r10(
    ...
    return {
        "format": "cur261-r10-policy-visible-supervised-dataset-v1",
...
def supervised_dataset_identity_r10(
    ...
    return {
        "format": "cur261-r10-supervised-dataset-identity-v1",
