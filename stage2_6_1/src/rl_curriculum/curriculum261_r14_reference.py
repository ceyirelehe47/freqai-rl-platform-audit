# -*- coding: utf-8 -*-
"""阶段 2.6.1 Repair R14:policy-visible reference 合同与 reference
...
def canonical_episode(episode: Any, preproc: Any) -> Any:
    ...
    reference_equivalence_run_r14 的 canonical 路径证明)。
    """
    import dataclasses
...
def policy_visible_reference_contract_static_digest() -> str:
    ...
    两级 digest 都以 r14pv- 前缀进入对应 plan identity。
    """
...
def reference_equivalence_run_r14(
    ...
    result = {
        "format": "cur261-r14-reference-equivalence-v1",
        "iteration": "r14",
