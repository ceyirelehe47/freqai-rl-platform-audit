# -*- coding: utf-8 -*-
"""阶段 2.6.1 Repair R17:policy-visible reference 合同与 reference
...
def canonical_episode(episode: Any, preproc: Any) -> Any:
    ...
    reference_equivalence_run_r17 的 canonical 路径证明)。
    """
    import dataclasses
...
def reference_equivalence_run_r17(
    ...
    result = {
        "format": "cur261-r17-reference-equivalence-v1",
        "iteration": "r17",
