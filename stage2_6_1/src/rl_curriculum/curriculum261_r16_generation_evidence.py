# -*- coding: utf-8 -*-
"""阶段 2.6.1 Repair R16:GenerationEvidenceCompleteness-v1(§15)。
...
治理层(R16 新增,orchestrator 重新计算,不信 recorder 自报):
...
COMPLETENESS_FORMAT = "cur261-r16-generation-evidence-completeness-v1"
R16_ITERATION = "r16"
...
def verify_generation_evidence_completeness(
    ...
    for r in rows:
        ...
        if env.get("iteration") != R16_ITERATION:
