...
FULL_COLD_READER_FORMAT = "cur261-r17-full-cold-reader-v1"
...
def read_full_cold_evidence(artifacts_dir: Path) -> dict[str, Any]:
    ...
    reader_checks = {
        ...
        "gate_topology_digest_present": bool(
            topology.get("digest", "").startswith("r17gt-")),
