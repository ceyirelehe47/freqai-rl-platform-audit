...
rd = Path("/mnt/f/trading/freqai-rl-audit/stage2_6_1/artifacts/"
          "repair17/development/unified_shutdown_cold_read/runs/"
          "final_20260907T163430")
...
print("coverage.win/guest_last_mono:",
...
print("run_record.required roles:", [e["role"] for e in r["required"]])
