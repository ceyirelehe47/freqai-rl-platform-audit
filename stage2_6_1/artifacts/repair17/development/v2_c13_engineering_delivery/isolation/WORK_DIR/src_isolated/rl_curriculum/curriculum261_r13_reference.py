# -*- coding: utf-8 -*-
"""阶段 2.6.1 Repair R13:policy-visible reference 合同与 reference
...
def canonical_episode(episode: Any, preproc: Any) -> Any:
    ...
    reference_equivalence_run_r13 的 canonical 路径证明)。
    """
    import dataclasses
...
def policy_visible_reference_contract_static_digest() -> str:
    ...
    两级 digest 都以 r13pv- 前缀进入对应 plan identity。
    """
...
def reference_equivalence_run_r13(
    ...
    result = {
        "format": "cur261-r13-reference-equivalence-v1",
        "iteration": "r13",
