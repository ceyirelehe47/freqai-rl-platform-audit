# -*- coding: utf-8 -*-
"""阶段 2.6.1 Repair R17:256-step PPO plumbing smoke(§30)。

只验证:V2 fit state 加载(ppo_smoke_r17 非 final namespace fit)、
...
§30:model manifest 绑定 V2 bundle hash + R17 parameter pack digest +
...
def run_ppo_smoke_r17(
    ...
    checks = {
        ...
        "r17_parameter_pack_digest_bound": (
    ...
    return {
        ...
        "model_manifest": {
            ...
            "r17_parameter_pack_digest": checks[
                "r17_parameter_pack_digest_bound"],
            ...
            "note": "§30:manifest 绑定 V2 bundle hash + R17 pack digest + "
