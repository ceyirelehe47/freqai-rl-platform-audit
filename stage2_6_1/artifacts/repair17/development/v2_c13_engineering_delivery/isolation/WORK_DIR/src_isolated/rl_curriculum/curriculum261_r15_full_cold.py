...
FULL_COLD_READER_FORMAT = "cur261-r15-full-cold-reader-v1"
...
def read_full_cold_evidence(artifacts_dir: Path) -> dict[str, Any]:
    ...
    for marker_name in ("qualification_exposure_r15.json",
    ...
    reader_checks = {
        ...
        "gate_topology_digest_present": bool(
            topology.get("digest", "").startswith("r15gt-")),
