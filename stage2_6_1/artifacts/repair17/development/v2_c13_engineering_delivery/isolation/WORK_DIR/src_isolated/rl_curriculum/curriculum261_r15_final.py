...
def _fresh_seed_validity_r15(n_checks: int = 10, *,
                             final_namespace: str = "qualification_r15",
                             holdout_namespace: str
                             = "fresh_holdout_r15") -> dict[str, Any]:
...
def execute_final_core_r15(
        ...
        fresh_seed_final_namespace: str = "qualification_r15",
        fresh_seed_holdout_namespace: str = "fresh_holdout_r15") -> dict[str, Any]:
...
def _execute_final_core_inner_r15(
    ...
    fresh = (_fresh_seed_validity_r15(
