# -*- coding: utf-8 -*-
"""R8 §36 测试:dedicated semantic corpus gate 与 candidate 语义(§15/
§16/§23/§26)。
...
semantic gate 测试使用真实 matched blocks(preplan_smoke_r8 namespace,
