...
# 用法(Windows): wsl -d CryptoRL-Ubuntu-24.04 -- bash -c "tr -d '\r' < /mnt/e/trading/freqai-rl-audit/stage2_6_1/runner/r17_sync.sh | bash"
# 或(WSL内): tr -d '\r' < /mnt/e/trading/freqai-rl-audit/stage2_6_1/runner/r17_sync.sh | bash
set -euo pipefail
...
# checkout;不从 /mnt/e drvfs 执行 shell/python)
