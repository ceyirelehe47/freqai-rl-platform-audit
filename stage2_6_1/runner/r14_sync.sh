#!/usr/bin/env bash
# R14:发布仓库(E:\trading\freqai-rl-audit) -> WSL 开发树(~/projects/crypto_rl)
# 用法(Windows): wsl -d CryptoRL-Ubuntu-24.04 -- bash -c "tr -d '\r' < /mnt/e/trading/freqai-rl-audit/stage2_6_1/runner/r14_sync.sh | bash"
# 或(WSL内): tr -d '\r' < /mnt/e/trading/freqai-rl-audit/stage2_6_1/runner/r14_sync.sh | bash
set -euo pipefail
...
mkdir -p "$D/artifacts/route_c_stage2_6_1_repair14"
echo "r14_sync: done (src+tests -> $D)"
