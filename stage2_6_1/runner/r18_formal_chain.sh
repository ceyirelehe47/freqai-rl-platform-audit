#!/usr/bin/env bash
# R18 尝试正式链(R17 框架 + 全新命名空间;journal §11 处方)——薄 shell 入口 + 单一协调者。
...
#
# 用法: bash r18_formal_chain.sh <commit_a_sha>
...
ART="$PROJECT_ROOT/artifacts/route_c_stage2_6_1_repair18"
...
emit_launch "launch_requested" "r18_formal_chain.sh $* run_id=$RUN_ID"
