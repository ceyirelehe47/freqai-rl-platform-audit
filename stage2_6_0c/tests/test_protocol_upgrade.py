...
def test_cli_version_constants_unified():
    ...
    assert fe.EXAM_CLI_VERSION == "hidden-exam-cli-v4"
...
def test_null_qualification_format_is_v2():
    from rl_curriculum.null_qualification import (
        NULL_QUALIFICATION_FORMAT,
    )

    assert NULL_QUALIFICATION_FORMAT == "null-qualification-v2"
