...
EXAM_CLI_VERSION = "hidden-exam-cli-v7"
...
def run_sealed_exam(
    *,
    ...
    try:
        ...
        # 5-6. 密封承诺 v6 逐项验证(含沙箱 profile/Null 资格/npb- 对账/
        #      完整 power 重跑/issuer/spec;duration contract 全链路对账;
        #      全部发生在候选 checkpoint 加载之前)
