...
def test_sealed_protocol_is_v6_and_v5_deprecated():
    ...
    assert SEALED_EXAM_PROTOCOL == "sealed-exam-commitment-v6"
...
def test_cli_is_v7():
    ...
    assert fe.EXAM_CLI_VERSION == "hidden-exam-cli-v7"
...
def test_builder_manifest_is_v2_and_v1_deprecated():
    ...
    assert BUILDER_MANIFEST_FORMAT == "null-pack-builder-manifest-v2"
