...
def build_mock_commitment(
    *, pack: ExamPack, charter: dict[str, Any], schema,
    ...
    if pack_validity_report.get("format") != "null-pack-validity-v2":
        raise ValueError(
            "pack validity 报告必须是 null-pack-validity-v2(每 seed "
    ...
    return SealedExamCommitment(
        ...
        pack_builder_code_hash=pack_builder_manifest_hash(),
        pack_validity={
        ...
        notes={"mock": True, "声明": "公开 mock 承诺 v5,验证密封基础设施用"},
    )
