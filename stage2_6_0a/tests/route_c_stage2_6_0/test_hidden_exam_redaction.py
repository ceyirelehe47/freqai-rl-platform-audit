...
@pytest.fixture()
def sealed_redact_env(tmp_path, formal_checkpoint):
    ...
    pack = ExamPack(
        ...
        episodes=[
            ...
            EpisodeSpec("probe_null_sign", {"episode_bars": 64}, 3,
                        "null_control", timeframe="15m"),
            EpisodeSpec("probe_null_block", {"episode_bars": 64}, 4,
                        "null_control", timeframe="15m"),
            EpisodeSpec("probe_null_volstate", {"episode_bars": 64}, 5,
                        "null_control", timeframe="15m"),
        ],
        timeframe="15m",
    )
