...
# builder-build-result-v2(规范化 attempt log:builder-attempt-log-v1)。
...
PRIVATE_BUILDER_A_FILES = {
    "builder_a.py": (
        ...
        "    '''builder-runner-protocol-v2 入口:精确单 request 位置参数,\n"
        ...
        "    return {\n"
        "        'format': 'builder-build-result-v2',\n"
        "        'runner_protocol': 'builder-runner-protocol-v2',\n"
        "        'status': 'ok', 'pack': pack,\n"
        "        'attempt_log': {\n"
        "            'format': 'builder-attempt-log-v1',\n"
