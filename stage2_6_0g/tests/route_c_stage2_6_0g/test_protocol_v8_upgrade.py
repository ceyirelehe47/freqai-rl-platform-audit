...
def test_protocol_constants_upgraded():
    ...
    assert BUILDER_RUNNER_PROTOCOL == "builder-runner-protocol-v2"
    assert BUILD_REQUEST_FORMAT == "builder-build-request-v2"
    assert BUILD_RESULT_FORMAT == "builder-build-result-v2"
    assert BUILDER_RUN_EVIDENCE_FORMAT == "builder-run-evidence-v1"
    assert EXAM_CLI_VERSION == "hidden-exam-cli-v9"
