...
def test_run_counterfactual_suite_returns_actual_replication_counts(
    ...
    阶段 2.6.0c 适配:取样数不再由 REPLICATION_SAMPLE_EPISODES 硬编码,
    而是按冻结判定器门槛 max(min_distinct_cheat_seeds,
    min_failing_cheat_episodes) 动态计算(工作包 C1)。
    """
