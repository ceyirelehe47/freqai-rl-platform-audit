...
def test_protocol_constants_upgraded():
    ...
    from rl_curriculum.builder_runner import RUNTIME_LOCK_FORMAT_V4

    assert RUNTIME_LOCK_FORMAT_V4 == "builder-runtime-lock-v4"
...
def test_evidence_v2_rejected_by_hash_fn(sealed_exam_env):
    ...
    with pytest.raises(Exception, match="builder-run-evidence-v4"):
